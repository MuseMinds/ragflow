...
| OCI application digest and embedded SDK checksum | Exact clean rebuilt source commit `bfd0d428aaa47ade853b393957d10ae3986f7202`: private GHCR OCI manifest `sha256:abbf8f7fa5d5719964a8464b840d53d3058761e25e0ee902bb9f71160f510499`; config `sha256:778e3d91247d8e8e4558b582602583c5ce00f5ee0c2f56fbd5ce98509401d185`; SDK SHA-256 `54bdba8548a77bcd308dd0ba0303dca48a22ed52b12dcd81e2d18855b424f0ef`. Commit tag and authenticated immutable reference resolve to the reviewed digest; package version `1121717328` was created by run `31509132031`; anonymous inspection is denied. |
| Develop ECR mirror | ECR tag `qualified-abbf8f7fa5d5` resolves to the byte-identical OCI manifest `sha256:abbf8f7fa5d5719964a8464b840d53d3058761e25e0ee902bb9f71160f510499`. The governed GHCR-to-ECR workflow completed idempotently in run `31509371244` without rebuilding or replacing the immutable destination tag. |
| Stateful service digests and config checksum | The same five exact stateful digests have fresh Syft/Trivy reports and are enumerated in Architecture Review 0040. RFC 8785 generation checksum `099c8bcc982d4450dab1e2caedfad533f16535d5abb5c129f9f045ee0b5ffc23`. |
| SBOM and vulnerability disposition | Exact application bundle SBOM produced with Syft 1.50.0; deterministic gzip SHA-256 `db7ba13f6f0bc073c784e4df30fecaca6a7dc5f0e6d137f0b3e4c204ee7ec365`. Trivy 0.70.0 found 0 Critical, 0 High, 55 Medium and 72 Low; deterministic report gzip SHA-256 `98b39bc9cf7a18553a2eb1b6f932c5a5028bca5abb2c6d4a00ae557a81516df2`. Fresh stateful scans confirm 11 Critical, 300 High, 499 Medium, 126 Low and 41 Unknown. Raffaele Berzoini explicitly accepted the bounded exact `develop` pilot risk in Architecture Review 0040 through 2026-09-30. |
| C-01–C-09 reproducible results | C-01 is `PASSED WITH TEMPORARY RISK ACCEPTANCE` for exact bundle `bfd0d428a…` and generation `099c8bcc…`. Source contract, clean build, runtime import, SBOM/scan, private publication and byte-identical ECR mirror evidence are complete. Target bootstrap/readiness and C-02–C-09 live reruns on this exact bundle remain pending; prior live results on `6bdea2b01…` are historical and are not inferred onto this bundle. |
