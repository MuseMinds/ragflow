...
| OCI application digest and embedded SDK checksum | Exact exercised protected commit `6bdea2b01fc33b6018fe7cc36a7064acb6ecd89e`: private GHCR OCI manifest `sha256:87a2f9f202e7f0a6084e5f8331b3b10f61de0fc2b3b1f1f8b2f6550b6d6ce5b6`; config `sha256:3bdebb1a6834dc85dfd979eb5bcad484ac830bb3ec16d3782a208731ad6163b0`; SDK SHA-256 `0ac6b0bde5deef54a00b1b223aea1a0a1769bb08648c95442540d90cad5af47a`. Tag and immutable-reference raw manifest bytes match the local OCI manifest; anonymous inspection is denied. |
| Develop ECR mirror | The manual `musemind-mirror-develop` workflow copies the exact qualified private GHCR manifest without rebuilding, uses the purpose-bound GitHub OIDC role and fails unless the ECR digest is byte-identical. An initial successful run must be recorded here before target deployment. |
...
| SBOM and vulnerability disposition | Application SBOM produced with Syft 1.50.0; Trivy 0.70.0 found 0 Critical and 0 High. Fresh stateful scans confirm 11 Critical/300 High. Raffaele Berzoini explicitly renewed the bounded `develop` pilot acceptance for this exact bundle/generation in Architecture Review 0037 through 2026-09-30. |
| C-01–C-09 reproducible results | C-01 is `PASSED WITH TEMPORARY RISK ACCEPTANCE`; C-02/C-03/C-04/C-05/C-06/C-08/C-09 and local/connector/full-rebuild portions of C-07M are `PASSED` on exact bundle `6bdea2b01…`. C-07M target EC2/EBS stop/start remains `IN PROGRESS`; no target deployment or first publish is inferred. |
